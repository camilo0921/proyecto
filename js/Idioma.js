$(document).ready(function(){
    ...
    $(document).on("click",".modificarIdi",function(){
    ...
    $(document).on("click",".eliminarIdi",function(){
      var url = $(this).attr("data-url");
      var id = $(this).attr("data-id");
    ...
    $(document).on('click','#registrarIdioma',function(){
    let valorIdioma=$('#idioma_desc').val().trim();
    

      if (validar('idioma_desc',valorIdioma)){
    ...
    $(document).on('keypress','.validarIdi',function(){
