$(document).ready(function(){
    ...
    $(document).on("click",".modificarG",function(){
    ...
    $(document).on("click",".eliminarG",function(){
      var url = $(this).attr("data-url");
      var id = $(this).attr("data-id");
    ...
    $(document).on('click','#registrarGenero',function(){
    let valorGenero=$('#genero_desc').val().trim();
    

      if (validar('genero_desc',valorGenero)){
    ...
    $(document).on('keypress','.validarGene',function(){
