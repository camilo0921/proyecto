$(document).ready(function(){
    ...
    $(document).on("click",".modificarEdi",function(){
    ...
    $(document).on("click",".eliminarEdi",function(){
      var url = $(this).attr("data-url");
      var id = $(this).attr("data-id");
    ...
    $(document).on('click','#registrarEditorial',function(){
    let valorEditorial=$('#editorial_desc').val().trim();
    

      if (validar('editorial_desc',valorEditorial)){
    ...
    $(document).on('keypress','.validarEdit',function(){
